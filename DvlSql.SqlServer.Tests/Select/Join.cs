...
public class Join
{
    ...
    public void InnerJoin(string joinToTable, string firstTableMatchingCol, string secondTableMatchingCol)
    {
        var actualSelect1 = _sql.From(TableName)
            .Join(joinToTable, ConstantExpCol(firstTableMatchingCol) == ConstantExpCol(secondTableMatchingCol))
            .Select()
            .ToString();
    ...
    {
        var actualSelect1 = _sql.From(TableName)
            .LeftJoin(joinToTable, ConstantExpCol(firstTableMatchingCol) == ConstantExpCol(secondTableMatchingCol))
            .Select()
            .ToString();
    ...
    {
        var actualSelect1 = _sql.From(TableName)
            .RightJoin(joinToTable, ConstantExpCol(firstTableMatchingCol) == ConstantExpCol(secondTableMatchingCol))
            .Select()
            .ToString();
    ...
    {
        var actualSelect1 = _sql.From(TableName)
            .FullJoin(joinToTable, ConstantExpCol(firstTableMatchingCol) == ConstantExpCol(secondTableMatchingCol))
            .Select()
            .ToString();
